...
<body class="dark-edition">
    ...
    -->
            <?php
          include 'include/v_dashboard.php';
          include 'include/h_dashboard.php';
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title"><strong class="text-uppercase ">Expenses
                                            Limit</strong>
                                    </h4>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control">
                                                        <option class="bmd-label-floating">Expenses Monthly</option>
                                                        <option>Ghc 100 - Ghc 500</option>
                                                        <option>Ghc 550 - Ghc 1000 </option>
                                                        <option>Ghc 1000 - Ghc 3500</option>
                                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating"> Lamborghini Mercy, Your
                                                            chick she so thirsty, I'm in that two seat
                                                            Lambo.</label>
